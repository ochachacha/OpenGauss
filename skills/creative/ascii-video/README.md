...
Built for [Gauss Agent](https://github.com/NousResearch/gauss-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/gauss-agent/skills/creative/ascii-video`](https://github.com/NousResearch/gauss-agent/tree/main/skills/creative/ascii-video) via PR.
