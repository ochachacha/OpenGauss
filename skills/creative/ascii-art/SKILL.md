...
```bash
python3 -m pyfiglet "GAUSS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=GAUSS&font=Slant" | boxes -d stone
```
