...
metadata:
  gauss:
    ...
    related_skills: [claude-code, gauss-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Gauss terminal. Codex is OpenAI's autonomous coding agent CLI.
