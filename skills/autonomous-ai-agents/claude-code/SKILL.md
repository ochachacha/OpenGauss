...
metadata:
  gauss:
    ...
    related_skills: [codex, gauss-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the Gauss terminal. Claude Code is Anthropic's autonomous coding agent CLI.
