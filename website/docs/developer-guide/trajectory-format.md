...
description: "How Gauss saves trajectories, normalizes tool calls, and produces training-friendly outputs"
---

# Trajectories & Training Format

Gauss can save conversation trajectories for training, evaluation, and batch data generation workflows.
...
Gauss converts live conversation structure into a training-friendly format.
