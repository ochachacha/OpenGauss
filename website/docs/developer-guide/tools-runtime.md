...
Gauss tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. Gauss resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`gauss-cli`, `gauss-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `gauss-acp`
