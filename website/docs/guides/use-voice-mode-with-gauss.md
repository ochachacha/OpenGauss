---
sidebar_position: 7
title: "Use Voice Mode with Gauss"
description: "A practical guide to setting up and using Gauss voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Gauss
...
- you want Gauss sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Gauss.
...
## Step 1: make sure normal Gauss works first
...
Gauss supports both local and cloud speech stacks.
...
4. Gauss transcribes and responds
...
- asking Gauss to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Gauss loop.

## Tuning CLI behavior

### Silence threshold

If Gauss starts/stops too aggressively, tune:
...
Gauss stays a normal chat bot, but can speak replies.
...
- you want Gauss to function like a portable research or ops assistant
...
Gauss joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Gauss detects speech boundaries
- transcripts are posted in the associated text channel
- Gauss responds in text and audio
...
1. get text Gauss working
2. install `gauss-agent[voice]`
