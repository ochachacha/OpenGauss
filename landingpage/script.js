// =========================================================================
// Gauss Agent Landing Page — Interactions
// =========================================================================
...
const demoSequence = [
  ...
  {
    type: "type",
    text: "Review the PR at NousResearch/gauss-agent#42 and fix any issues",
    delay: 30,
  },
  { type: "pause", ms: 600 },
  {
...
// --- Noise Overlay (ported from gauss-chat NoiseOverlay) ---
