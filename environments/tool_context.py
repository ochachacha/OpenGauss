...
ALL gauss-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all gauss-agent tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any gauss-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("GAUSS_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("GAUSS_QUIET", None)
            else:
                os.environ["GAUSS_QUIET"] = _prev_quiet
