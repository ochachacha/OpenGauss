...
Inspired by: GroceryMind — production Gauss agent doing live web research
             across German grocery stores (firecrawl + gauss-agent)
"""
...
# Ensure gauss-agent root is on path
...
class WebResearchEnvConfig(GaussAgentEnvConfig):
...
class WebResearchEnv(GaussAgentBaseEnv):
    """
