...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("gauss")
        class GaussToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "gauss", "mistral", "llama3_json")
...
from environments.tool_call_parsers.gauss_parser import GaussToolCallParser  # noqa: E402, F401
