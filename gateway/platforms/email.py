"""
Email platform adapter for the Gauss gateway.

Allows users to interact with Gauss by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Gauss Agent")
        ...
        msg_id = f"<gauss-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
