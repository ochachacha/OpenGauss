...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("GAUSS_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "Gauss stopped Telegram polling to avoid endless retry spam. "
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if not acquired:
                ...
                message = (
                    "Another local Gauss gateway is already using this Telegram bot token"
            ...
            try:
                ...
                await self._bot.set_my_commands([
                    ...
                    BotCommand("update", "Update Gauss to the latest version"),
                    BotCommand("prove", "Show how to launch guided Lean proving"),
                    BotCommand("draft", "Show how to launch Lean drafting"),
                    BotCommand("autoprove", "Show how to launch autonomous Lean proving"),
                    BotCommand("formalize", "Show how to launch interactive Lean formalization"),
                    BotCommand("autoformalize", "Show how to launch autonomous Lean formalization"),
