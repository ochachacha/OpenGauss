...
DEFAULT_AGENT_IDENTITY = (
    ...
    "start, explain that they should first create or activate a Gauss project "
    "with /project, then run /prove, /autoprove, /formalize, or "
    "/autoformalize followed by a natural-language instruction, for example "
    "/autoprove The de Bruijn - Erdos theorem. If they attach to a child "
    "session with /swarm attach, tell them Ctrl-] detaches and returns them "
    "to the main Gauss session. "
