...
DEFAULT_DATASETS = [
    ...
    "NousResearch/gauss-agent-megascience-sft1",
    "NousResearch/Gauss-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Gauss-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-gauss-agent"
]
