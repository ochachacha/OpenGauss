 ...
 *
 * Usage:
 *   node bridge.js --port 3000 --session ~/.gauss/whatsapp/session
 */
...
const SESSION_DIR = getArg('session', path.join(process.env.HOME || '~', '.gauss', 'whatsapp', 'session'));
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['Gauss Agent', 'Chrome', '120.0'],
