...
class TestParserRegistry:
    ...
    def test_gauss_parser_registered(self):
        parsers = list_parsers()
        assert "gauss" in parsers
...
class TestGaussParser:
    @pytest.fixture
    def parser(self):
        return get_parser("gauss")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["gauss"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use gauss format since that's universal
