"""Tests for slash command prefix matching in GaussCLI.process_command."""
...
class TestSlashCommandPrefixMatching:
    ...
    def test_exact_command_with_args_does_not_recurse(self):
        ...
        original_pc = GaussCLI.process_command
        ...
        with patch.object(GaussCLI, 'process_command', guarded):
            try:
