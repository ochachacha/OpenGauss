"""Tests for the interactive session browser (`gauss sessions browse`).
...
from gauss_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """gauss sessions browse should be parseable."""
        from gauss_cli.main import main as _main_entry
