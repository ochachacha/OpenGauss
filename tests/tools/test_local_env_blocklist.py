...
Verifies that Gauss-managed provider, tool, and gateway env vars are
stripped from subprocess environments so external CLIs are not silently
misrouted or handed Gauss secrets.

See: https://github.com/NousResearch/gauss-agent/issues/1002
See: https://github.com/NousResearch/gauss-agent/issues/1264
"""
...
class TestProviderEnvBlocklist:
    """Provider env vars loaded from ~/.gauss/.env must not leak."""
