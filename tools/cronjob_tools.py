"""
Cron job management tools for Gauss Agent.
...
def _origin_from_env() -> Optional[Dict[str, str]]:
    origin_platform = os.getenv("GAUSS_SESSION_PLATFORM")
    origin_chat_id = os.getenv("GAUSS_SESSION_CHAT_ID")
    if origin_platform and origin_chat_id:
        return {
            "platform": origin_platform,
            "chat_id": origin_chat_id,
            "chat_name": os.getenv("GAUSS_SESSION_CHAT_NAME"),
...
def check_cronjob_requirements() -> bool:
    ...
    return bool(
        os.getenv("GAUSS_INTERACTIVE")
        or os.getenv("GAUSS_GATEWAY_SESSION")
        or os.getenv("GAUSS_EXEC_ASK")
    )
