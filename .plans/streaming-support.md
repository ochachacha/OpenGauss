# Streaming LLM Response Support for Gauss Agent
...
```
GAUSS_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("GAUSS_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `gauss_cli/config.py` | 1 | +streaming config defaults |
